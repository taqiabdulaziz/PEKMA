...
public class OlahragaData {
    ...
    public String getResultpa() {
        return resultpa;
    }

    public void setResultpa(String resultpa) {
        this.resultpa = resultpa;
    }
    ...
    public void setResultpb(String resultpb) {
