...
import id.pekma.pekmavii.FragmentResult.Akademik.AdapterResultOlahraga;
import id.pekma.pekmavii.FragmentResult.ResultFragment;
import id.pekma.pekmavii.MainActivity;
import id.pekma.pekmavii.R;

public class FragmentSeni extends Fragment implements ResultFragment.SendCabol{
    ...
    public class AsyncFetch extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                url = new URL("https://pekma.id/result1.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i=0;i<jsonArray.length();i++){
                    ...
                    homeData.namaPeserta = json_data.getString("namateam");
                    homeData.nilai = json_data.optInt("nilai");
                    homeData.namaTema = json_data.optString("tema");
                    homeData.jurta=json_data.optString("jurusan");
                    homeData.idevent = json_data.optInt("idcat");
                ...
                AdapterSeni mAdapter = new AdapterSeni(getActivity(), data);
